    ...
    return (
        <>
            <div className="mx-auto px-4 sm:px-6 lg:px-8 bg-[#000000]">
                <h1 className="sm:p-[90px] p-10 text-[#FFFFFF] text-center font-bold text-5xl font-mono">NEWS</h1>
            </div>

            <section className="py-2">
                <div className="container mx-auto sm:p-10 p-4 sm:pl-[14rem] grid sm:grid-cols-3 grid-cols-1 justify-between gap-6">

                    <div className="flex flex-col gap-6" data-aos="zoom-in-right" data-aos-duration="1500">
                    ...
                    <div className="sm:col-span-2  w-full flex flex-col gap-4">
                        <div className="flex flex-col bg-[#F8F8F8] text-justify">
                            ...
                            <div className="p-4 flex flex-col gap-4">
                                <span className="font-bold text-xl text-[#333333]">Etiam eleifend ac tellus aliquet congue.</span>
                                <div className="flex flex-col sm:flex-row sm:items-center gap-8">
                                    <div className="flex items-center gap-2">
                                        <div>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.5" d="M8 0.25C3.71875 0.25 0.25 3.71875 0.25 8C0.25 12.2812 3.71875 15.75 8 15.75C12.2812 15.75 15.75 12.2812 15.75 8C15.75 3.71875 12.2812 0.25 8 0.25ZM8 14.25C4.53125 14.25 1.75 11.4688 1.75 8C1.75 4.5625 4.53125 1.75 8 1.75C11.4375 1.75 14.25 4.5625 14.25 8C14.25 11.4688 11.4375 14.25 8 14.25ZM9.90625 11C10.0938 11.125 10.3125 11.0938 10.4375 10.9062L11.0312 10.125C11.1562 9.9375 11.125 9.71875 10.9375 9.59375L8.875 8.0625V3.625C8.875 3.4375 8.6875 3.25 8.5 3.25H7.5C7.28125 3.25 7.125 3.4375 7.125 3.625V8.78125C7.125 8.875 7.15625 9 7.25 9.0625L9.90625 11Z" fill="#333333" />
                                            </svg>
                                        </div>
                                        <span className="text-[#333333]">Apr 25, 2021</span>
                                    </div>
                                    <div>
                                        <span className="text-[#333333]">Posted by: Rome Doel</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <div>
                                        <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path opacity="0.5" d="M9 0C4.5625 0 1 2.9375 1 6.5C1 8 1.59375 9.375 2.625 10.4688C2.1875 11.6875 1.21875 12.75 1.1875 12.75C0.96875 12.9688 0.9375 13.2812 1.03125 13.5625C1.15625 13.8438 1.4375 14 1.75 14C3.65625 14 5.1875 13.2188 6.09375 12.5625C7 12.8438 7.96875 13 9 13C13.4062 13 17 10.0938 17 6.5C17 2.9375 13.4062 0 9 0ZM9 11.5C8.15625 11.5 7.3125 11.375 6.53125 11.125L5.8125 10.9062L5.21875 11.3438C4.78125 11.6562 4.15625 12 3.40625 12.25C3.65625 11.875 3.875 11.4375 4.03125 11L4.375 10.125L3.71875 9.4375C3.15625 8.84375 2.5 7.84375 2.5 6.5C2.5 3.75 5.40625 1.5 9 1.5C12.5625 1.5 15.5 3.75 15.5 6.5C15.5 9.28125 12.5625 11.5 9 11.5Z" fill="#333333"/>
</svg>

                                        </div>
                                        <span className="text-[#333333]">0 Comments</span>
                                    </div>
                                </div>
