  ...
  return (
    <> 
        <div className="mx-auto px-4 sm:px-6 lg:px-8 bg-[#000000]">
            <h1 className="sm:p-[90px] p-10 text-[#FFFFFF] text-center font-bold text-5xl font-mono">SERVICE-DETAIL</h1>
        </div>

        <section className="py-2 relative">
            <div className="container mx-auto sm:p-10 p-4 sm:pl-[10rem] grid sm:grid-cols-3 grid-cols-1 gap-4">
                <div className="sm:w-4/5 flex flex-col gap-6 justify-center" data-aos="zoom-in-right" data-aos-duration="1500">
